...
class CryptKickerHarnessTests(unittest.TestCase):
    ...
    def test_002(self):
        letter_key = self.create_letter_key_via_offset(15)
        ...
        expected_result = "seem clear only reason"
        enc_line = self.encrypt_line(expected_result, letter_key)
        print(enc_line)
        result = crypt_decrypt(enc_line, dictionary)
        self.assertEqual(expected_result, result)

        expected_result = "it seem very clear that only reason"
        enc_line = self.encrypt_line(expected_result, letter_key)
        print(enc_line)
        result = crypt_decrypt(enc_line, dictionary)
        self.assertEqual(expected_result, result)

        expected_result = "it seem very clear that the only reason that"
        enc_line = self.encrypt_line(expected_result, letter_key)
        print(enc_line)
        result = crypt_decrypt(enc_line, dictionary)
        self.assertEqual(expected_result, result)
    ...
    def create_letter_key_via_offset(self, offset):
        letter_key = {}
